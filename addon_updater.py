...
class SingletonUpdater:
    ...
    def __init__(self):
        ...
        # Handle case where __package__ might be None or incorrect
        try:
            pkg = __package__ if __package__ else "addon_updater"
            self._addon = pkg.lower()
            self._addon_package = pkg  # Must not change.
        except:
            self._addon = "addon_updater"
            self._addon_package = "addon_updater"
        ...
        self._ignore_this_session = False  # Track ignore for current session only
    ...
    def ignore_update(self):
        """Ignore update for this session only (not permanent)"""
        self._ignore_this_session = True
        self.print_verbose("Update ignored for this session")
